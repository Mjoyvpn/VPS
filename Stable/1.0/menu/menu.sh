...
echo -e "Current Domain      = $( cat /etc/joysmark/domain.txt )";
...
case $choosemu in
    ...
    16) 
        ...
        # // Input Domain To VPS
        echo "$new_domains" > /etc/joysmark/domain.txt;
    ...
    18)
        ...
        echo $email_input > /etc/joysmark/email.txt
        clear;
    ...
    ;;
    28) cd /root/; wget -q -O /root/update.sh "https://raw.githubusercontent.com/Mjoyvpn/VPS/main/vpn-script/Stable/update.sh"; chmod +x /root/update.sh; ./update.sh; rm -f /root/update.sh ;;
    29)
            clear
            # // clearlog
