...
case $choosemu in
    ...
    ;;
    28) cd /root/; wget -q -O /root/update.sh "https://raw.githubusercontent.com/Mjoyvpn/VPS/main/Stable/update.sh"; chmod +x /root/update.sh; ./update.sh; rm -f /root/update.sh ;;
    29)
            clear
            # // clearlog
