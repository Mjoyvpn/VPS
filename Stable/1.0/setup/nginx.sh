...
./configure --prefix=/etc/joysmark/webserver/ \
...
wget -q -O /etc/nginx/conf.d/joysmark.conf "https://raw.githubusercontent.com/Mjoyvpn/VPS/main/vpn-script/Resource/Config/joysmark_conf";
mkdir -p /etc/joysmark/webserver/;
wget -q -O /etc/joysmark/webserver/index.html "https://raw.githubusercontent.com/Mjoyvpn/VPS/main/vpn-script/Resource/Config/index.file";
sudo chown -R www-data:www-data /etc/joysmark/webserver/;
sudo chmod 755 /etc/joysmark/webserver/;
