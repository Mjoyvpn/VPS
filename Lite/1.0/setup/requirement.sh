...
wget -q -O /etc/systemd/system/udp-mini-2.service "https://raw.githubusercontent.com/Mjoyvpn/VPS/mai/Resource/Service/udp-mini-2.service";
...
wget -q -O /etc/wildydev21/autokill.conf "https://raw.githubusercontent.com/Mjoyvpn/VPS/main/Stable/1.0/menu/pro/autokill/autokill_conf";
